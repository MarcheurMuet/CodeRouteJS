...
questionsD.push(new Question("Vous voyez un camion qui pile que faite vos dans cette situation? :", [0, 1, 0, -1], ["Vous priez", "Vous priez", "Vous vous la jouer Batman et esquivez le camion", "Vous vous dites qu'il valait peut-être mieux lire le texte sur le camion en fin de compte..."]));
...
questionsD.push(new Question("J'arrive à la sortie en direction des Hautes-Pyrénées d'ici 10 minutes. Que dois-je dire à la personne que je vais voir pour prévenir ? :", [0, 0, 1, -1], ["j'arrive bientôt", "je suis quasiment là", "je vais pas a Tarbes", ""]));
